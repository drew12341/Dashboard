create view indicator_measures_aggregate as
  ...
  from indicator_measures inner join indicators on indicator_measures.indicatorid = indicators.id where category = 'standard' and indicator_measures.committed = 1 group by period, indicatorid
